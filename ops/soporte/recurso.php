...
if(@$_POST['guardar'] == 'enviar') {
  ...
  $nRecu = trim(mysqli_real_escape_string($gestambu, $_POST['nomRecu']));


  $sql = "INSERT INTO recurso (nomRecu) VALUES ('$nRecu')";
...
//Mostrar registros
$mosRecu = mysqli_query($gestambu, "SELECT * FROM recurso ORDER BY idRecu asc")
...
<head>
  ...
  <title>GestAmbu 3.0 | Nuevo tipo de recurso</title>
  <!-- Ancho de pantalla -->
        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Nuevo tipo de recurso:</h3>
              ...
              <div class="box-body">
                ...
                <div class="col-md-8">
                  <div class="form-group <?php if(isset($_POST['guardar'])) {echo $menCl; } ?> ">
                    <label for="nomRecu" class="col-sm-2 control-label">Nombre Recurso: </label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nomRecu" placeholder="Nombre de recurso" title="Ha de ingresar algún caracter" required />
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php while($rRecu = mysqli_fetch_array($mosRecu)) { ?>
                <tr>
                  <td><?php echo $rRecu['idRecu']; ?></td>
                  <td><?php echo $rRecu['nomRecu']; ?></td>
                </tr>
                <?php } ?>
              </table>
            </div>
