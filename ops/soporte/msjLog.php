...
if(@$_POST['guardar'] == 'enviar') {
  ...
  $descLog = trim(mysqli_real_escape_string($gestambu, $_POST['msjLog']));

  $sql = "INSERT INTO msjlog (msjLog) VALUES ('$descLog')";
...
//Mostrar registros
$mosLog = mysqli_query($gestambu, "SELECT * FROM msjlog ORDER BY idLog asc")
...
<head>
  ...
  <title>GestAmbu 3.0 | Nuevo mensaje para Log</title>
  <!-- Ancho de pantalla -->
        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Nuevo mensaje de log:</h3>
                ...
                <div class="col-md-8">
                  <div class="col-md-12">
                    <div class="form-group <?php if(isset($_POST['guardar'])) {echo $menCl; } ?> ">
                      <label for="vaEst" class="control-label">Mesaje a mostrar: </label>
                        <input type="text" class="form-control" name="msjLog" placeholder="Mensaje de log" title="Ha de ingresar algún caracter" required />
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php while($rwLog = mysqli_fetch_array($mosLog)) { ?>
                <tr>
                  <td><?php echo $rwLog['idLog']; ?></td>
                  <td><?php echo $rwLog['msjLog']; ?></td>
                </tr>
                <?php } ?>
              </table>
            </div>
