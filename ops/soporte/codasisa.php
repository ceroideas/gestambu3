...
if(@$_POST['guardar'] == 'enviar') {
  ...
  $codigo = trim(mysqli_real_escape_string($gestambu, $_POST['codigo']));
  $descripcion = trim(mysqli_real_escape_string($gestambu, $_POST['descripcion']));

  $sql = "INSERT INTO codigoasisa (codigo, descripcion) VALUES ('$codigo', '$descripcion')";
...
//Mostrar registros
$mosEstado = mysqli_query($gestambu, "SELECT * FROM codigoasisa ORDER BY codigo ASC");
...
<head>
  ...
  <title>GestAmbu 3.0 | Codigos Asisa</title>
  <!-- Ancho de pantalla -->
        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Nuevo Código:</h3>
                ...
                <div class="col-md-8">
                  <div class="col-md-4">
                    <div class="form-group <?php if(isset($_POST['guardar'])) {echo $menCl; } ?> ">
                      <label for="vaEst" class="control-label">Código: </label>
                        <input type="text" class="form-control" name="codigo" placeholder="Número de código" title="Ha de ingresar algún caracter" required />
                        <?php if(isset($_POST['guardar'])) {echo $mensa; } ?>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group ">
                      <label for="vaEst" class="control-label">Descripción: </label>
                        <input type="text" class="form-control" name="descripcion" placeholder="Descripción" title="Ha de ingresar algún caracter" required />
                    </div>
                  </div>
              </div>
                <div class="col-md-2"></div>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  <td><?php echo $rwEstado['codId']; ?></td>
                  <td><?php echo $rwEstado['idServi']; ?></td>
                  <td><?php echo $rwEstado['codigo']; ?></td>
                  <td><?php echo $rwEstado['descripcion']; ?></td>
                </tr>
                <?php } ?>
              </table>
            </div>
