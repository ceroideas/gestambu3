...
if(@$_POST['guardar'] == 'enviar') {
  ...
  $sql = "INSERT INTO cate (cate) VALUES ('$cate')";
...
//Mostrar registros
$nCate = mysqli_query($gestambu, "SELECT * FROM cate ORDER BY idCate asc")
...
<head>
  ...
  <title>GestAmbu 3.0 | Categorías</title>
  <!-- Ancho de pantalla -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-8">
                  <div class="form-group <?php if(isset($_POST['guardar'])) {echo $menCl; } ?> ">
                    <label for="usNom" class="col-sm-2 control-label">Nombre Categoría: </label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="cate" placeholder="Categoría" title="Ha de ingresar algún caracter" required />
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php while($rCate = mysqli_fetch_array($nCate)) { ?>
                <tr>
                  <td><?php echo $rCate['idCate']; ?></td>
                  <td><?php echo $rCate['cate']; ?></td>
                </tr>
                <?php } ?>
              </table>
            </div>
