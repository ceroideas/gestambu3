...
$obsText = "Ha visaulizado las incidencias";
$usuario = $_SESSION['userId'];
guardarLog('6', $usuario, $obsText, $registro);


/* Datos de Log de servicio */
$inciSv = mysqli_query($gestambu, "SELECT incidencia.idInci, incidencia.idSv, incidencia.incHora, incidencia.descInci, incidencia.descInci, incidencia.userInci, incidencia.motivoInci, incidencia.enviaInci, user.userId, user.usNom, user.usApe
  FROM incidencia
    LEFT JOIN user ON incidencia.userInci = user.userId
  WHERE incidencia.idSv = '$registro'
  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Incidencia de servicio</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-header">
          ...
          <h3 class="box-title">Incidencias para el servicio: <i>id <?php echo $registro; ?></i></h3>
        ...
        <div class="box-body chat" id="chat-box">
          <!-- chat item -->
          <?php while($rwInci = mysqli_fetch_assoc($inciSv)) { ?>
          <div class="item">
            <img src="/ico/users/<?php echo mostrarIcoUser($rwInci['userId']); ?>" alt="user image" class="online">

            <p class="message">
              <a href="#" class="name">
                <small class="text-muted"><i class="fa fa-clock-o"></i> <?php echo $rwInci['enviaInci']; ?></small>
                 - <?php echo $rwInci['usNom']." ".$rwInci['usApe']; ?>
              </a>
              Motivo: <?php mostMotv($rwInci['motivoInci']); ?>
            </p>
            <div class="attachment">
              <h4>Incidencia:</h4>

              <p class="filename">
                <?php echo substr($rwInci['incHora'], 0, 5)." ".$rwInci['descInci']; ?>
              </p>
            </div>
            <!-- /.attachment -->
          </div>
