...
if(@$_POST['guardar'] == 'enviar') {
  ...
  if($rwFilt['nuevo'] == 0 ) {
    ...
    $mensaLogM = trim(mysqli_real_escape_string($gestambu, $_POST['mensalog']));
    $estServ   = trim(mysqli_real_escape_string($gestambu, $_POST['estServ']));
	$activa    = trim(mysqli_real_escape_string($gestambu, $_POST['activacion']));
    ...
    if(empty($pacienteID)) {
      $sqlServicio = "INSERT INTO servicio (CoDemanda, idemanda, idasistencia, idCia, DNIPac, poliza, autorizacion, provincia, tipo, recurso, fecha, hora, delegacion, medico, enfermero, idvta, fest, nombre, apellidos, tlf1, tlf2, sexo, edad, recoger, locRec, trasladar, locTras, obs, estServ)
        VALUES ('$coDemanda','$idemandAsisa', '$idasistencia', '$cia', '$DNI', '$poliza', '$auto', '$prov', '$tipo', '$recurso', '$fecha', '$horaFor', '$deleg', '$medico', '$due', '$idvta', '$fst', '$nombre', '$apellidos', '$tlf1', '$tlf2', '$sexo', '$edadTab', '$recoger', '$locRec', '$trasladar', '$locTras', '$obs', '$estServ')
        ";
    } else {
      ...
      $sqlServicio = "INSERT INTO servicio (CoDemanda, idemanda, idasistencia, idCia, idPac, DNIPac, poliza, autorizacion, provincia, tipo, recurso, fecha, hora, delegacion, medico, enfermero, idvta, fest, nombre, apellidos, tlf1, tlf2,
          sexo, edad, recoger, locRec, trasladar, locTras, obs)
        VALUES ('$coDemanda','$idemandAsisa', '$idasistencia', '$cia', '$pacienteID', '$DNI', '$poliza', '$auto', '$prov', '$tipo', '$recurso', '$fecha', '$horaFor', '$deleg', '$medico', '$due', '$idvta', '$fst', '$nombre', '$apellidos', '$tlf1', '$tlf2',
          '$sexo', '$edadTab', '$recoger', '$locRec', '$trasladar', '$locTras', '$obs')
        ";
    }
    ...
    if(mysqli_query($gestambu,$sqlServicio)) {
      ...
      if(mysqli_query($gestambu, $serinfoIns)) {
        ...
        if(!empty($mensaLogM)) {
          guardarLog('18', $usuario, $mensaLogM, $idInsertado);
        }
        /* Actualiza estado de asisa demanda */
		# Obtiene la hora para guardar como ACTIVACION para Asisa */	
		$hActivacion  = obtenerHoraActivacion($activa);		
        $demandaUp = mysqli_query($gestambu, "UPDATE asisademanda SET nuevo='0', activacion='$hActivacion' WHERE idemanda='$idemandAsisa' ");
        ...
        echo "Error:ln163 " . $serinfoIns . "<br>" . mysqli_error($gestambu);
      }
    } else {
      echo "Error:ln170 " . $sqlServicio . "<br>" . mysqli_error($gestambu);
    }
  }
}
        ...
        <div class="col-xs-12">
          <div class="box box-info box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Nuevo servicio<?php if(isset($barraEst)) { echo " - ".$barraEst; } ?></h3>
            ...
            <div class="box-body">
              <form class="form-vertical form-label-left" action="" method="post">
                ...
                <!-- /Mensajes -->
                  ...
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    <label>Póliza: </label>
                    <input type="text" class="form-control" placeholder="Póliza" name="poliza" value="<?php echo convertPoli($rwAsisa['num_poliza']); ?>">
                  </div>
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="input-group">
                      <input type="date" class="form-control" name="fecha" id="fecha" value="<?php echo muestraFechAsisa($rwAst['fecha_asistencia']); ?>" required="">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="input-group">
                      <input type="time" class="form-control" name="hora" id="hora" value="<?php if(isset($hDCsta) && $hDCsta == 1) { } else { echo date("H:i");} ?>" required="">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-5 col-sm-6 col-xs-5">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="ABONADO o PACIENTE si se desconocen los datos" name="nombre" required id="nombre" value="<?php echo $rwAsisa['nombre']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-7 col-sm-6 col-xs-7">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Apellidos" name="apellidos" value="<?php echo sanear_string($rwAsisa['apellido1']." ".$rwAsisa['apellido2']); ?>">
                      <div class="input-group-addon">
                        <i class="fa fa-user"></i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-4 col-sm-3 col-xs-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Teléfono 1" name="tlf1"  value="<?php echo $rwAsisa['telefono_contacto1']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-3 col-xs-3">
                    <label class="control-label">Teléfono: </label>
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Teléfono 2" name="tlf2" value="<?php echo $rwAsisa['telefono_contacto2']; ?>">
                      <div class="input-group-addon">
                        <i class="fa fa-phone"></i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="recoger" id="recoger" value="<?php echo $rwAsisa['direccion_origen']; if(!empty($rwAsisa['localizacion_origen'])) { echo " ".$rwAsisa['localizacion_origen']; } ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control localidad" name="locRec" value="<?php echo $rwAsisa['poblacion_origen_nombre']; ?>">
                      <div class="input-group-addon">
                        <i class="fa">L</i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="trasladar" value="<?php echo $rwAsisa['direccion_destino']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    <label class="control-label">Localidad: </label>
                    <div class="input-group">
                      <input type="text" class="form-control localidad" name="locTras" value="<?php echo $rwAsisa['poblacion_destino_nombre']; ?>">
                      <div class="input-group-addon">
                        <i class="fa">L</i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <textarea class="form-control" rows="3" placeholder="Observaciones" name="obs"><?php echo $rwAsisa['motivo']." - ".$rwAsisa['observaciones_p']." - ".$rwAsisa['observaciones_s']; //if(isset($menObs)) { echo " ".$menObs; }?></textarea>
                  </div>
                  <div class="form-group col-md-2 col-sm-2 col-xs-2">
