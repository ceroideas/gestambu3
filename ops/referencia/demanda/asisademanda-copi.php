                ...
                if($numCol == 0 ) {
                  ...
                  while($rwAsisa = mysqli_fetch_array($sqlAsisa)) {
					...
					if($codServ > 60 && $codServ < 64) {
						...
						$sqlSes = mysqli_query($gestambu, "SELECT  cod_demanda, fecha_asistencia, COUNT(cod_demanda) AS nSesiones, estado FROM asisaasistencia WHERE cod_demanda = '$coDeman' GROUP BY fecha_asistencia ");
					}
