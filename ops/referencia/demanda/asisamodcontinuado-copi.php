...
if(@$_POST['guardar'] == 'enviar') {
  ...
  if($rwFilt['nuevo'] == 0 ) {
	...
	if($recurso == '2') {
		...
		$compNsesion = mysqli_query($gestambu, "SELECT cod_demanda, fecha_asistencia, estado FROM asisaasistencia WHERE cod_demanda = '$codeAsisa' GROUP BY fecha_asistencia");
	}    
            ...
            <div class="box-body">
              <form class="form-vertical form-label-left" action="" method="post">
                ...
                <!-- /Mensajes -->
                  ...
                  <!-- Sesiones -->
                  <?php
                  if($rwTabDem['cod_servicio'] > 60 && $rwTabDem['cod_servicio'] < 64) {
