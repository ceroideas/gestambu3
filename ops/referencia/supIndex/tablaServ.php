...
<head>
  ...
  <title>GestAmbu 3.0 | Tabla de servicios </title>
  <!-- Ancho de pantalla -->
...
<script>
  const idTable = 'serviceSearch';
  let url = '/gestambu/www/ops/tabIndex/querys/queryServices/postGetServices.php'
</script>
