...
if(@$_POST['guardar'] == 'enviar') {
  ...
  if(empty($pacienteID)) {
    ...
    if($pacienteID == $idPac) {
      ...
      $sqlServicio = "INSERT INTO servicio (idCia, idPac, DNIPac, poliza, autorizacion, provincia, tipo, recurso, fecha, hora, delegacion, medico, enfermero, idvta, fest, nombre, apellidos, tlf1, tlf2, sexo, edad, recoger, locRec, trasladar, locTras, obs)
        VALUES ('$cia', '$idPac', '$DNI', '$poliza', '$auto', '$prov', '$tipo', '$recurso', '$fecha', '$horaFor', '$deleg', '$medico', '$due', '$idvta', '$fst', '$nombre', '$apellidos', '$tlf1', '$tlf2', '$sexo', '$edadTab', '$recoger', '$locRec', '$trasladar', '$locTras', '$obs')
        ";
    } else {
  ...
  if(mysqli_query($gestambu,$sqlServicio)) {
    ...
    if(mysqli_query($gestambu, $serinfoIns)) {
      $mensa   = "Servicio creado correctamente";
      $mensaOk = '1';
...
# Selector del recurso
if(isset($_GET['selRec'])) {
  $selRec = $_GET['selRec'];
} else {
  $selRec = '1';
}

# Datos para el servicio - vinculado desde Tabla de Paciente
              ...
              <form class="form-vertical form-label-left" action="" method="post">
                ...
                <!-- /Mensajes -->
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="trasladar" value="">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    <label class="control-label">Localidad: </label>
                    <div class="input-group">
                      <input type="text" class="form-control localidad" name="locTras" value="">
                      <div class="input-group-addon">
                        <i class="fa">L</i>
                      </div>
                    </div>
