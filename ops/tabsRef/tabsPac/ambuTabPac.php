...
$datPac = mysqli_query($gestambu,"SELECT servicio.idSv, DATE_FORMAT(servicio.fecha, '%d-%m-%y') AS fechaFor, servicio.fecha, servicio.hora, servicio.tipo, servicio.recurso, servicio.provincia, servicio.autorizacion, servicio.recoger, servicio.locRec, servicio.trasladar, servicio.locTras, servicio.estServ,
  ...
  WHERE servicio.idPac = '$identPac' AND servicio.recurso IN('1','3','5')
  ORDER BY servicio.fecha DESC
  ");

?>
<div class="box-header">
  <h3 class="box-title">Servicios de Ambulancia</h3>
</div>
<!-- /.box-header -->
<div class="box-body table-responsive no-padding">
  <table class="table table-hover">
    ...
    <tr>
      ...
      <td><?php echo $rwDatPac['recuCorto']; ?></td>
      ...
      <td><?php echo $rwDatPac['trasladar']; ?></td>
      <td><?php echo $rwDatPac['locTras']; ?></td>
