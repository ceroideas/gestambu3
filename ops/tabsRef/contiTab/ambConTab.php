...
$ambCount = mysqli_query($gestambu, "SELECT servicio.idSv, COUNT(servicio.continuado) AS restantes, servicio.continuado, servicio.codRuta, servicio.idCia, servicio.poliza, servicio.autorizacion, servicio.provincia AS provPac, servicio.tipo, servicio.recurso,
...
recurso.idRecu, recurso.nomRecu, refcontinuado.numCont, refcontinuado.sesiones, refcontinuado.pauta, refcontinuado.estCont, serinfo.idSv, serinfo.hconsulta, provincias.id, provincias.provincia
FROM servicio
...
WHERE servicio.continuado != '0' AND servicio.estServ NOT IN('10', '14', '15') AND servicio.recurso IN('1', '3', '5', '7') AND servicio.provincia IN($provTab) AND servicio.codRuta ='0'
GROUP BY servicio.continuado
ORDER BY servicio.nombre ASC");

$total_records = $ambCount->num_rows;
...
<div class="row">
            ...
            <div class="box-body no-padding">
              <table class="table table-condensed">
                ...
                <tr>
                  ...
                  <td><div class="horas" id="hconsulta-<?php echo $rwCont['continuado'];?>-sInfo"><?php echo substr(sinHora($rwCont['hconsulta']), 0, 5); ?></div></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><div class="edRuta" id="codRuta-<?php echo $rwCont['continuado'];?>"><?php if($rwCont['codRuta'] == '0') { echo "SIN RUTA";} else { echo $rwCont['codRuta']; } ?></div></td>
                </tr>
              </table>
            </div>
          </div>
  ...
  <?php } ?>
                ...
                <div style="padding-left: 2rem;">  <?php displayPaginateComponent($total_records, $total_pages, $page, "page", "ambuClick"); ?> </div>
  <!-- /.Detalles de continuado -->
</div>
<!-- /.row -->
<!-- Jeditable -->
