  ...
  # comprueba si existe id en la tabla paciente
    ...
    if(empty($pacienteID)) {
      ...
      if(mysqli_query($gestambu, $refcontIns)) {
        ...
        echo "Error: 122 " . $refcontIns . "<br>" . mysqli_error($gestambu);
      }
      ...
      for ($nS=1; $nS<=$sesiones; $nS++) {
        ...
        if(mysqli_query($gestambu,$sqlServicio)) {
          ...
          if(mysqli_query($gestambu, $serinfoIns)) {
            ...
            echo "Error: 155 " . $serinfoIns . "<br>" . mysqli_error($gestambu);
          }
        } else {
          echo "Error: 158" . $sqlServicio . "<br>" . mysqli_error($gestambu);
        }
      }
    } else {
      //Inserta registro en tabla refcontinuado
      ...
      if(mysqli_query($gestambu, $refcontIns)) {
        ...
        echo "Error: 175 " . $refcontIns . "<br>" . mysqli_error($gestambu);
      }
      ...
      for ($nS=1; $nS<=$sesiones; $nS++) {
        ...
        if(mysqli_query($gestambu,$sqlServicio)) {
          ...
          if(mysqli_query($gestambu, $serinfoIns)) {
            ...
            echo "Error: 206 " . $serinfoIns . "<br>" . mysqli_error($gestambu);
          }
        } else {
          echo "Error: 209 " . $sqlServicio . "<br>" . mysqli_error($gestambu);
        }
      }
    }
}
                ...
                <!-- /Mensajes -->
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <input type="hidden" name="codRuta" value="<?php echo $ruta; ?>">
