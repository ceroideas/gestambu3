...
@$identCont   = trim(mysqli_real_escape_string($gestambu, $_POST['idenCont']));
@$ruta        = trim(mysqli_real_escape_string($gestambu, $_POST['codRuta']));

$pauGuardar  = $pauta;

/* Datos a copiar */
$varCopiar = mysqli_query($gestambu, "SELECT *
  FROM servicio
  WHERE idSv = '$identCont'
  ");
$rwCopiar = mysqli_fetch_assoc($varCopiar);

# Edad del paciente
@$edaDatos = explode(" ", $rwCopiar['edad']);
@$numEdad  = $edaDatos[0];
@$texEdad  = $edaDatos[1];
...
if(@$_POST['guardar'] == 'enviar') {
  ...
  $ruta		 = trim(mysqli_real_escape_string($gestambu, $_POST['ruta']));
  ...
  $serestadoIns = mysqli_query($gestambu, "INSERT INTO refcontinuado (numCont, sesiones, pauta) VALUES ('$rhResul', '$sesiones', '$pauta')");

  if(empty($pacienteID)) {
    for ($nS=1; $nS<=$sesiones; $nS++) {
      //Inserta en la tabla servicio
      $fecha = trim(mysqli_real_escape_string($gestambu, $_POST['fecha'.$nS.'']));
      $sqlServicio ="INSERT INTO servicio (continuado, codRuta, idCia, DNIPac, poliza, autorizacion, provincia, tipo, recurso, fecha, hora, delegacion, medico, enfermero, idvta, fest, nombre, apellidos, tlf1, tlf2, sexo, edad, recoger, locRec, trasladar, locTras, obs)
        VALUES ('$rhResul', '$ruta', '$cia', '$DNI', '$poliza', '$auto', '$prov', '$tipo', '$recurso', '$fecha', '$horaFor', '$deleg', '$medico', '$due', '$idvta', '$fst', '$nombre', '$apellidos', '$tlf1', '$tlf2', '$sexo', '$edadTab', '$recoger', '$locRec', '$trasladar', '$locTras', '$obs')
        ";
      ...
      if(mysqli_query($gestambu,$sqlServicio)) {
        ...
        if(mysqli_query($gestambu, $serinfoIns)) {
          ...
          echo "Error: 161 " . $serinfoIns . "<br>" . mysqli_error($gestambu);
        }
      } else {
        echo "Error: 164" . $sqlServicio . "<br>" . mysqli_error($gestambu);
      }
    }
  } else {
    for ($nS=1; $nS<=$sesiones; $nS++) {
      $fecha = trim(mysqli_real_escape_string($gestambu, $_POST['fecha'.$nS.'']));
      $sqlServicio = "INSERT INTO servicio (continuado, codRuta, idCia, idPac, DNIPac, poliza, autorizacion, provincia, tipo, recurso, fecha, hora, delegacion, medico, enfermero, idvta, fest, nombre, apellidos, tlf1, tlf2, sexo, edad, recoger, locRec, trasladar, locTras, obs)
        VALUES ('$rhResul', '$ruta', '$cia', '$pacienteID', '$DNI', '$poliza', '$auto', '$prov', '$tipo', '$recurso', '$fecha', '$horaFor', '$deleg', '$medico', '$due', '$idvta', '$fst', '$nombre', '$apellidos', '$tlf1', '$tlf2', '$sexo', '$edadTab', '$recoger', '$locRec', '$trasladar', '$locTras', '$obs')
        ";
      //Inserta en la tabla serinfo
      if(mysqli_query($gestambu,$sqlServicio)) {
        // Ultimo id ingresado con $gestambu
        ...
        if(mysqli_query($gestambu, $serinfoIns)) {
          ...
          echo "Error: 196 " . $serinfoIns . "<br>" . mysqli_error($gestambu);
        }
      } else {
        echo "Error: 199 " . $sqlServicio . "<br>" . mysqli_error($gestambu);
      }
    }
  }
}
        ...
        <div class="col-xs-12">
          <div class="box box-info box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Renovar servicio</h3>
                ...
                <!-- /Mensajes -->
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-4 form-group">
                    ...
                    <select class="form-control" name="provincia" id="prov" required="">
                      ...
                      <option value="29" <?php if($rwCopiar['provincia'] == '29') {echo "selected=\"selected\""; } ?>>Málaga</option>
					  <option value="52" <?php if($rwCopiar['provincia'] == '52') {echo "selected=\"selected\""; } ?>>Melilla</option>
                      <option value="41" <?php if($rwCopiar['provincia'] == '41') {echo "selected=\"selected\""; } ?>>Sevilla</option>
                      <option value="11" <?php if($rwCopiar['provincia'] == '11') {echo "selected=\"selected\""; } ?>>Cádiz</option>
					  <option value="14" <?php if($rwCopiar['provincia'] == '14') {echo "selected=\"selected\""; } ?>>Córdoba</option>
					  <option value="21" <?php if($rwCopiar['provincia'] == '21') {echo "selected=\"selected\""; } ?>>Huelva</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="DNI sin guiones ni espacios" name="DNIPac" value="<?php echo $rwCopiar['DNIPac']; ?>">
                  ...
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    <label>Póliza: </label>
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Póliza" name="poliza" value="<?php echo $rwCopiar['poliza']; ?>">
                      <div class="input-group-addon">
                        <i class="fa">P</i>
                      </div>
                    </div>
                      ...
                      <select class="form-control" name="delegacion">
                        ...
                        <?php
                          while($rDelg = mysqli_fetch_assoc($lsDeleg)) {
                            if($rwCopiar['delegacion'] == $rDelg['id']) {
                              $seleccion = "selected";
                            } else {
                              $seleccion = "";
                            }
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="input-group">
                      <input type="time" class="form-control" name="hora" id="hora" value="<?php echo $rwCopiar['hora']; ?>">
                      <div class="input-group-addon">
                      ...
                      <select class="form-control" name="tipo" id="tipo">
                        ...
                        <?php
                          while($rServ = mysqli_fetch_assoc($tServ)) {
                            if($rwCopiar['tipo'] == $rServ['idServi']) {
                              $seleccion = "selected";
                            } else {
                              $seleccion = "";
                            }
                      ...
                      <select class="form-control" name="recurso" id="recurso">
                        ...
                        <?php
                          while($rRecu = mysqli_fetch_assoc($tRecu)) {
                            if($rwCopiar['recurso'] == $rRecu['idRecu']) {
                              $seleccion = "selected";
                            } else {
                              $seleccion = "";
                            }
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <label id="valMedico">Médico
                        <input class="col-md-8" type="checkbox" class="minimal" name="medico" id="medico" value="1" <?php if($rwCopiar['medico'] == 1) { echo "checked"; } ?>>
                      </label>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <label id="valDue">Due
                        <input class="col-md-8" type="checkbox" class="minimal" name="enfermero" id="due" value="1" <?php if($rwCopiar['enfermero'] == 1) { echo "checked"; } ?>>
                      </label>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <label id="valIda">Ida
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <label id="valIdavta">Ida/vta
                        <input class="col-md-8" type="checkbox" class="minimal" name="idvta" id="idvta" value="1" <?php if($rwCopiar['idvta'] == 1) { echo "checked"; } ?>>
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-5 col-sm-6 col-xs-5">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="ABONADO o PACIENTE si se desconocen los datos" name="nombre" required id="nombre" value="<?php echo $rwCopiar['nombre']; ?>">
                      <input type="hidden" name="idPac" value="<?php echo $rwCopiar['idPac']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-7 col-sm-6 col-xs-7">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Apellidos" name="apellidos" value="<?php echo $rwCopiar['apellidos']; ?>">
                  ...
                  <div class="form-group col-md-4 col-sm-3 col-xs-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Teléfono 1" name="tlf1"  value="<?php echo $rwCopiar['tlf1']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-3 col-xs-3">
                    <label class="control-label">Teléfono: </label>
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Teléfono 2" name="tlf2" value="<?php echo $rwCopiar['tlf2']; ?>">
                      <div class="input-group-addon">
                        <i class="fa fa-phone"></i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-1 col-sm-2 col-xs-2">
                    <label class="control-label">Sexo: </label>
                      <select class="form-control" name="sexo">
                        <option value="">---</option>
                        <option value="H" <?php if($rwCopiar['sexo'] == "H") { echo "selected"; } ?>>Hombre</option>
                        <option value="M" <?php if($rwCopiar['sexo'] == "M") { echo "selected"; } ?>>Mujer</option>
                      </select>
                  </div>
                  <div class="form-group col-md-1 col-sm-2 col-xs-2">
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="recoger" id="recoger" value="<?php echo $rwCopiar['recoger']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control localidad" name="locRec" value="<?php echo $rwCopiar['locRec']; ?>">
                      <div class="input-group-addon">
                        <i class="fa">L</i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="trasladar" value="<?php echo $rwCopiar['trasladar']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    <label class="control-label">Localidad: </label>
                    <div class="input-group">
                      <input type="text" class="form-control localidad" name="locTras" value="<?php echo $rwCopiar['locTras']; ?>">
                      <div class="input-group-addon">
                        <i class="fa">L</i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-2 col-sm-2 col-xs-2">
                    ...
                    <!-- Ha de definirse de acuerdo con las prioridadades de las compañías -->
                      <select class="form-control" name="prioridad">
                        <option value="3" <?php if($rwSerinfoMos['prioridad'] == "0") { echo "selected"; } ?>> - Sin prioridad - </option>
                        ...
                        <option value="4" <?php if($rwSerinfoMos['prioridad'] == "3") { echo "selected"; } ?>>Hora fija</option>
						<option value="5" <?php if($rwSerinfoMos['prioridad'] == "3") { echo "selected"; } ?>>Hora desde</option>
                      </select>
                  ...
                  <div class="form-group col-md-2 col-sm-2 col-xs-2">
                    ...
                    <input type="time" class="form-control has-feedback" name="hvuelta" title="Tiempo que estará en consulta" value="<?php if($rwSerinfoMos['hvuelta'] == '00:00:00') { } else { echo $rwSerinfoMos['hvuelta']; } ?>">
