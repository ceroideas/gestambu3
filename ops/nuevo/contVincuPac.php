...
<head>
  ...
  <title>GestAmbu 3.0 | Continuado vinculado</title>
  <!-- Ancho de pantalla -->
...
<?php include '../inc/menubar.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Formulario de nuevo servicio continuado viculado
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-6 col-md-offset-3">
                  <form class="form-horizontal form-label-left" action="continuadoVincuPac.php" method="post">
                    ...
                    <div class="form-group col-md-6 col-md-offset-3">
                      <div class="col-md-6 col-md-offset-3">
                        <input type="hidden" name="refId" value="<?php echo $registro; ?>" >
