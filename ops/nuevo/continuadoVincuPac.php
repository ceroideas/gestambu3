...
@$refId      = trim(mysqli_real_escape_string($gestambu, $_POST['refId'])); // id paciente
...
$copiarDatos = mysqli_query($gestambu, "SELECT * FROM paciente WHERE idPac='$refId'");
...
<?php include '../inc/menubar.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Formulario de nuevo servicio continuado por id de paciente
                ...
                <!-- /Mensajes -->
                  ...
                  <div class="form-group col-md-3 col-sm-3 col-xs-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="DNI sin guiones ni espacios" name="DNIPac" value="<?php echo $rwVincu['pacDNI']; ?>">
                  ...
                  <div class="form-group col-md-5 col-sm-6 col-xs-5">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="ABONADO o PACIENTE si se desconocen los datos" name="nombre" required id="nombre" value="<?php echo $rwVincu['pNombre']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-7 col-sm-6 col-xs-7">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Apellidos" name="apellidos" value="<?php echo $rwVincu['pApellidos']; ?>">
                      <div class="input-group-addon">
                        <i class="fa fa-user"></i>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="recoger" id="recoger" value="<?php echo $rwVincu['direccion']; ?>">
                      <div class="input-group-addon">
                  ...
                  <div class="form-group col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control localidad" name="locRec" value="<?php echo $rwVincu['localidad']; ?>">
                      <div class="input-group-addon">
                        <i class="fa">L</i>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <input type="hidden" name="idPac" value="<?php echo $refId; ?>">
