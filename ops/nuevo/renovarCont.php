...
//Pauta anterior
$pautAnt = mysqli_query($gestambu, "SELECT numCont, pauta FROM refcontinuado WHERE numCont = '$idCont'");
$rwPautaAnt = mysqli_fetch_assoc($pautAnt);

//Identificación de uno de los servicios para duplicar los datos
$idenAnt = mysqli_query($gestambu, "SELECT idSv, continuado, fecha FROM servicio WHERE continuado='$idCont' ORDER BY fecha DESC");
$rwIdentAnt = mysqli_fetch_assoc($idenAnt);

$datosCopiar = $rwIdentAnt['idSv'];
...
<head>
  ...
  <title>GestAmbu 3.0 | Renovar continuado</title>
  <!-- Ancho de pantalla -->
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-6 col-md-offset-3">
                  <form class="form-horizontal form-label-left" action="contDatosRenovar.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <select name="pauta" class="form-control">
                          ...
                          <option value="1" <?php if($rwPautaAnt['pauta'] == 1 ) { echo "selected"; } ?>>Cada 24h</option>
                          <option value="2" <?php if($rwPautaAnt['pauta'] == 2 ) { echo "selected"; } ?>>Cada 48h</option>
                          <option value="3" <?php if($rwPautaAnt['pauta'] == 3 ) { echo "selected"; } ?>>Cada 72h</option>
                          <option value="4" <?php if($rwPautaAnt['pauta'] == 4 ) { echo "selected"; } ?>>De Lunes a Viernes</option>
                          <option value="5" <?php if($rwPautaAnt['pauta'] == 5 ) { echo "selected"; } ?>>Lunes - Miércoles - Viernes</option>
                          <option value="6" <?php if($rwPautaAnt['pauta'] == 6 ) { echo "selected"; } ?>>Martes - Jueves - Sábados</option>
                          <option value="7" <?php if($rwPautaAnt['pauta'] == 7 ) { echo "selected"; } ?>>Sábados y Domingos</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-3">
                        ...
                        <input type="hidden" name="idenCont" value="<?php echo $datosCopiar; ?>">
                      </div>
                    </div>
