...
$sqlAmbu = mysqli_query($gestambu,
  ...
  servicio.locRec, servicio.trasladar, servicio.locTras, servicio.estServ, servicio.apellidos, servicio.obs, servicio.creadoNu, cia.idCia, cia.ciaNom,
 ...
 <div class="tab-pane active" id="tab_1">
     <div class="box-tools">
       <div class="input-group input-group-sm" style="width: 150px;">
         <input type="text" name="table_search" class="form-control pull-right" placeholder="Busqueda" id="dueTerm" onkeyup="doSearch()">
   ...
   <div class="box-body table-responsive no-padding">
     <table class="table table-hover h6" id="datosDue">
       <thead>
         <th>#</th>
		 <th></th>
		 <th></th>
...
?>
         ...
         <td><div class="editDue" id="dueIda-<?php echo $rwAmbTab['idSv']; ?>"><?php if($rwAmbTab['dueIda']==0) {echo "";} {echo $rwAmbTab['dueIda'];} ?></div></td>
 ...
 <script language="javascript">
   function doSearch() {
     ...
     var tableReg = document.getElementById('datosDue');
     var searchText = document.getElementById('dueTerm').value.toLowerCase();
     var cellsOfRow="";
     var found=false;
     var compareWith="";
