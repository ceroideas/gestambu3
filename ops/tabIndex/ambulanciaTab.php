...
<div class="tab-pane active" id="tab_1">
  <div class="box-tools">
    <div class="input-group input-group-sm" style="width: 150px;">
      <input type="text" name="table_search" class="form-control pull-right" placeholder="Busqueda" id="ambTerm"
        onkeyup="doSearch()">
          ...
          ?>">
            ...
            <td class="h5 sinmar"><a class="<?php if ($colBlanco == 1) {
              echo "linkBlank";
                ...
                href="/ops/mostrar/editServ.php?iden=<?php echo $rwAmbTab['idSv']; ?>" title="Editar"><i
                  class="fa <?php compInci($rwAmbTab['idSv']); ?>"></i></a></td>
            <!-- Abrir modal para ver servicio completo -->
            <td class="h5 sinmar"><a class="<?php if ($colBlanco == 1) {
              echo "linkBlank";
            } ?>" href="#"
                data-target="#modal-<?php echo $rwAmbTab['idSv']; ?>" data-toggle="modal" title="Ver servicio">
                <i class="fa fa-<?php echo icoEsTec($rwAmbTab['estTec'], $rwAmbTab['estTecVta'], $rwAmbTab['estServ'], $rwAmbTab['idvta']); ?>"
                  onclick="limpiar('copyAnswer-<?php echo $rwAmbTab['idSv']; ?>')"></i>
              </a>
            </td>
            <td class="h5 sinmar">
              <?php echo compImpreso($rwAmbTab['idSv']); ?>
            </td>
            <!-- Modal -->
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Servicio para:
                      <?php echo $rwAmbTab['idSv'] . " - " . $rwAmbTab['nombre'] . " " . $rwAmbTab['apellidos']; ?> <span
                        id="copyAnswer-<?php echo $rwAmbTab['idSv']; ?>" class="label label-success"></span>
                    </h4>
                  </div>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                      onclick="copiarAlPortapapeles('textoCopiar-<?php echo $rwAmbTab['idSv']; ?>', 'copyAnswer-<?php echo $rwAmbTab['idSv']; ?>')">Copiar
                      texto</button>
            ...
            <td>
              <?php provValor($rwAmbTab['provincia']); ?>
            </td>
            <td>
              <?php echo $rwAmbTab['nombre']; ?>
            </td>
            <td>
              <?php echo $rwAmbTab['ciaNom']; ?>
            </td>
            <td>
              <?php if (@verUltima($rwAmbTab['continuado']) == 1) {
                echo "U L T I M A";
              } else {
            ...
            <td>
              <?php echo ambComple($rwAmbTab['recurso'], $rwAmbTab['enfermero'], $rwAmbTab['medico'], $rwAmbTab['nomRecu']); ?>
            </td>
            <td data-toggle="tooltip" title="<?php echo $rwAmbTab['edad'] . "-" . $rwAmbTab['obs']; ?>"><?php echo $rwAmbTab['recoger']; ?></td>
            <td>
              <?php echo $rwAmbTab['locRec']; ?>
            </td>
            <td data-toggle="tooltip"
              title="<?php if (!empty(sinHoraSeg($rwAmbTab['HVTA']))) {
                echo "Vuelta: " . $rwAmbTab['HVTA'];
              } ?>"><?php echo $rwAmbTab['trasladar']; ?></td>
            <td>
              <?php echo $rwAmbTab['locTras']; ?>
            </td>
            <?php if ($rwAmbTab['idvta'] == 3) { ?>
              <td><i class="fa fa-close"></i></td>
            <?php } else { ?>
              <td>
                <div class="vhlist" id="vhIda-<?php echo $rwAmbTab['idSv']; ?>"><strong>
                    <?php mostrarVehiculo($rwAmbTab['vhIda']); ?>
                  </strong></div>
              </td>
            <?php }
            if ($rwAmbTab['idvta'] == 2) { ?>
            ...
            <?php } else { ?>
              <td>
                <div class="vhlist" id="vhVta-<?php echo $rwAmbTab['idSv']; ?>"><strong>
                    <?php mostrarVehiculo($rwAmbTab['vhVta']); ?>
                  </strong></div>
              </td>
            <?php }
            if ($rwAmbTab['idvta'] == 3) { ?>
            ...
            <?php } else { ?>
              <td>
                <div class="hora" id="idReco-<?php echo $rwAmbTab['idSv']; ?>"><?php echo sinHoraSeg($rwAmbTab['idReco']); ?>
                </div>
              </td>
              <td>
                <div class="hora" id="idFin-<?php echo $rwAmbTab['idSv']; ?>"><?php echo sinHoraSeg($rwAmbTab['idFin']); ?>
                </div>
              </td>
            <?php }
            if ($rwAmbTab['idvta'] == 2) { ?>
            ...
            <?php } else { ?>
              <td>
                <div class="hora" id="vtaReco-<?php echo $rwAmbTab['idSv']; ?>"><?php echo sinHoraSeg($rwAmbTab['vtaReco']); ?></div>
              </td>
              <td>
                <div class="hora" id="vtaFin-<?php echo $rwAmbTab['idSv']; ?>"><?php echo sinHoraSeg($rwAmbTab['vtaFin']); ?>
                </div>
              </td>
            <?php } ?>
            <td>
              <div class="<?php estJeditable($rwAmbTab['idvta']); ?>" id="estServ-<?php echo $rwAmbTab['idSv']; ?>"><?php
                   echo $rwAmbTab['vaEst']; ?></div>
            </td>
          </tr>
        <?php }
      } ?>
