...
<?php while($rwExt = mysqli_fetch_array($extraccion)) { ?>
			<li role="presentation">
				<a role="menuitem" tabindex="-1" href="#"><?php echo fechaNom($rwExt['fecha']); ?> 
					<span class="pull-right-container">
						<small class="label pull-right bg-yellow">E-<?php echo $rwExt['extSe']; ?></small>					
						<small class="label pull-right bg-blue"><?php echo $rwExt['capSe']; ?></small>
					</span>
				</a>
			</li>
<?php } ?>
...
<?php while($rwExt = mysqli_fetch_array($extraccionMa)) { ?>
			<li role="presentation">
				<a role="menuitem" tabindex="-1" href="#"><?php echo fechaNom($rwExt['fecha']); ?> 
					<span class="pull-right-container">
						<small class="label pull-right bg-yellow">E-<?php echo $rwExt['extMa']; ?></small>					
						<small class="label pull-right bg-blue"><?php echo $rwExt['capMa']; ?></small>
					</span>
				</a>
			</li>
<?php } ?>
