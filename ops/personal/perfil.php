                  ...
                  <div class="form-group has-feedback">
                    ...
                    <div class="col-sm-9 has-feedback">
                      <select class="form-control" name="usProv">
						...
						<option value="14" <?php if($rwUser['usProv'] == '14') {echo "selected=\"selected\""; } ?>>Córdoba</option>
                        <option value="29" <?php if($rwUser['usProv'] == '29') {echo "selected=\"selected\""; } ?>>Málaga</option>
						<option value="52" <?php if($rwUser['usProv'] == '52') {echo "selected=\"selected\""; } ?>>Melilla</option>
						<option value="21" <?php if($rwUser['usProv'] == '21') {echo "selected=\"selected\""; } ?>>Huelva</option>
