...
<?php function displayPaginateComponent($total_records, $total_pages, $page, $pageKey = "page", $tabKey)
{
    ...
    // console_log([$total_records, $total_pages, $page, $pageKey, $tabKey]);
    if ($total_pages > 0) { ?>
...
<script>
    ...
    function getRouteParams(page, total_pages, filters, pageKey, tabKey) {
        ...
        if(tabKey) urlWithParams.searchParams.append('activeTab', tabKey);
        console.log(urlWithParams.searchParams)
        // $("#eduClick").click()

        let tab = $(tabKey).attr('href');

        switch (tab) {
            case '#tab_1':

                $.get('/ops/tabsRef/contiTab/ambConTab.php', {prov: filters.prov, page: page}, function(htmlexterno){
            ...
            case '#tab_2':
                ...
                $.get('/ops/tabsRef/contiTab/dueConTab.php', {prov: filters.prov, page: page}, function(htmlexterno){
            ...
            case '#tab_3':
                ...
                $.get('/ops/tabsRef/contiTab/medConTab.php', {prov: filters.prov, page: page}, function(htmlexterno){
