...
$servList = mysqli_query($gestambu, "SELECT servicio.idSv, servicio.coDemanda, servicio.idCia, servicio.tipo, servicio.recurso, servicio.fecha, DATE_FORMAT(servicio.hora, '%H:%i') AS hora, servicio.medico, servicio.enfermero,
  ...
  WHERE servicio.idSv = '$idSv' AND servicio.estServ != '15'
  ");
$rwLiServ = mysqli_fetch_assoc($servList);

/* Listado cie9 */
$cie9 = mysqli_query($gestambu, "SELECT * FROM cie9");
...
<head>
  ...
  <title>Incidencia | GestAmbu 3.0 </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <div class="box-header with-border">
          <h3 class="box-title">Id servicio: <?php echo $rwLiServ['idSv']; ?></h3>
        </div>
        <!-- Mensajes -->
      ...
      <div class="box-footer no-padding">
        <ul class="nav nav-pills nav-stacked">
          <li><a href="#" onclick="enviarIncidencia(<?php echo "3"; ?>, 'Ausente en domicilio', <?php echo $usuario; ?> );"><i class="fa fa-close"></i> Ausente en domicilio</a></li>
          <li><a href="#" onclick="enviarIncidencia(<?php echo "2"; ?>, 'Se niega a traslado', <?php echo $usuario; ?> );"><i class="fa fa-frown-o"></i> Se niega a traslado</a></li>
          <li><a href="#" onclick="enviarIncidencia(<?php echo $rwLiServ['idEst']; ?>, 'Otro recurso en domicilio', <?php echo $usuario; ?> );"><i class="fa fa-cab"></i> Otro recurso en domicilio</a></li>
          <li><a href="#" data-target="#inciOtros" data-toggle="modal"><i class="fa fa-exclamation-triangle"></i> Otros motivos</a></li>
        </ul>
        <?php include('../referencia/modals/inciOtros.php'); ?>
      </div>
    </section>
    <!-- /.content -->
  </div>
